...
const newsArticleData = {
  ...
  subtitle: 'Эксперты делятся советами по выявлению мошеннических писем и сайтов.',
  imageUrl: '/images/new_2.png',
  date: '10 июня 2025',
  category: 'Безопасность',
  content: `
    <p class="mb-6 text-xl text-slate-700">В последнее время мошенники стали чаще обманывать людей через интернет. Они присылают поддельные письма и создают фальшивые сайты, чтобы украсть ваши деньги и личные данные. Давайте разберемся, как защититься от таких обманов.</p>
    
    <h2 class="text-3xl font-semibold mt-10 mb-6 text-slate-800">Как распознать обманное письмо?</h2>
    <p class="mb-6 text-xl text-slate-700">Вот главные признаки опасного письма:</p>
    <ul class="list-disc list-inside mb-6 pl-6 text-xl text-slate-700 space-y-3">
      <li><strong>Незнакомый отправитель:</strong> Вас просят что-то сделать (например, перевести деньги) от имени банка или госучреждения, но адрес письма выглядит подозрительно.</li>
      <li><strong>Срочность:</strong> В письме требуют срочно что-то сделать ("Ваш счет заблокируют!", "Срочно обновите данные").</li>
      <li><strong>Ошибки:</strong> В тексте много опечаток, странных слов или неправильных обращений.</li>
      <li><strong>Ссылки и вложения:</strong> Просят перейти по ссылке или открыть вложение — никогда не делайте этого!</li>
    </ul>

    <h2 class="text-3xl font-semibold mt-10 mb-6 text-slate-800">Как проверить подозрительный сайт?</h2>
    <p class="mb-6 text-xl text-slate-700">Если вас просят ввести пароль или данные карты:</p>
    <ol class="list-decimal list-inside mb-6 pl-6 text-xl text-slate-700 space-y-3">
      <li><strong>Посмотрите на адрес сайта</strong> — он должен начинаться с "https://" и иметь значок замка рядом</li>
      <li><strong>Проверьте название сайта</strong> — мошенники часто используют похожие названия вроде "СберБанк" вместо "Сбербанк"</li>
      <li><strong>Не вводите данные</strong> — если сомневаетесь, позвоните в банк или организацию по официальному номеру</li>
    </ol>

    <h2 class="text-3xl font-semibold mt-10 mb-6 text-slate-800">Простые правила защиты</h2>
    <ul class="list-disc list-inside mb-6 pl-6 text-xl text-slate-700 space-y-3">
      <li>Никому не сообщайте пароли и коды из SMS</li>
      <li>Установите антивирус — он предупредит об опасных сайтах</li>
      <li>Если сомневаетесь — позвоните родственникам или в банк</li>
      <li>Не торопитесь — мошенники всегда создают ложное ощущение срочности</li>
    </ul>
  `,
};
